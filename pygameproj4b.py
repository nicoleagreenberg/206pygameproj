...
class PanSprite(pygame.sprite.Sprite):
    def __init__(self, groups, hotpan_groups):
        ...
        self.groups = [groups, hotpan_groups]
...
def main():
    ...
    hot_pan = pygame.sprite.Group()

    empty = pygame.Surface((X_MAX, Y_MAX))
    clock = pygame.time.Clock()

    pan = PanSprite(everything, hot_pan)
    pan.add(everything)
    ...
    while True:
        ...
        hit_pan = pygame.sprite.groupcollide(
            enemies, hot_pan, True, True) #HOW TO MAKE 
